...
if __name__ == "__main__":
    ...
    rewards_dqn_50 = get_data("rewards_DQN_n_50.txt")
    rewards_dqn_100 = get_data("rewards_DQN_n_100.txt")
    rewards_dqn_150 = get_data("rewards_DQN_n_150.txt")

    rewards_q_final = get_data("rewards_Q_final.txt")
    rewards_dqn_final = get_data("rewards_DQN_final.txt")
    rewards_dqn_complicated = get_data("rewards_DQN_complicated.txt")
    rewards_dqn_very_complicated = get_data("rewards_DQN_very_complicated.txt")
    ...
    plot_diff([get_avg(rewards_main, length), get_avg(rewards_decay_9999, length), get_avg(rewards_decay_9998, length), get_avg(rewards_decay_9997, length)], ["Non decay", "Q d=0.9999", "Q d=0.9998", "Q d=0.9997"], title="Rewards for r=0.25, lr=0.05 and y=0.1")
    ...
    plot_diff([get_avg(rewards_q_final, length), get_avg(rewards_dqn_final, length), get_avg(rewards_dqn_complicated, length), get_avg(rewards_dqn_very_complicated, length)], ["Q (r=0.25, lr=0.05, y=0.1, d=0.9997)", "DQN (l=[125], y=0.1, d=0.9997)", "Complicated (l=[100, 100], y=0.1, d=0.9997)", "Very complicated (l=[150,  150, 150], y=0.1, d=0.9997)"], title="Q vs DQN (+ complicated)")
